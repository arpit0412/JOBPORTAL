...
export default class JobSeekerSearch extends NavigationMixin(LightningElement) {
   ...
   JobInfo =false;
    ...
    SearchJobHandler(event){
        ...
        {
            insertRecordToJob({seekId:this.userId,recId:this.titUserId,recordId:this.titId})
            .then(data=>{
        ...
        handleSaveJob(){
            ...
            .then(response =>{
                ...
                console.log('seeker id is::'+id1);
            })
            .catch(error =>{
                console.error('getCurrentSeekerId'+error);
            })
        }
